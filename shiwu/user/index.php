...
<div id="main">
    ...
    <div id="pinpai">
        <div class="pinpai_con">
            ...
            <p class="gushi">故事</p>
            <p class="gushi_con">优贝乐母健康食品，希望带着“分享优质食材”的坚持。</p>
            <p class="gushi_two">为母婴提供一口感动舌尖的美味，更为增添一份撼动心灵的人情。一份菜品、一口美味，都是生活的酸甜苦辣。</p>
    ...
    <div id="jiameng">
        <div class="jiameng_left">
            <p class="firm">优贝乐母项目组</p>
            <p class="jiam">电话：15002376097</p>
            <p class="jiam">地址：重庆师范大学</p>
            <p class="jiam">邮箱：610171031@qq.com</p>
        </div>
