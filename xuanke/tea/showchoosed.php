...
if(! isset($_SESSION['username']))
{
	...
	$ShowCourse_sql="select * from course,stucou where course.Teacher=(select TeaName from Teacher) and course.CouNo=stucou.CouNo ORDER BY StuNo";
	$ShowCourseResult=db_query($ShowCourse_sql);
?>
<?php include("header.php");?>
<table width="700" border="0" align="center" cellpadding="0" cellspacing="1">
     <tr bgcolor="#0066CC">
	     <td width="80" align="center"><font color="#FFFFFF">所选学生</font></td>
		 ...
		 <td width="80"><font color="#FFFFFF" align="center">添加成绩</font></td>
     </tr>
<?php
	...
	for($i=0;$i<$number;$i++){
		...
		if($i>=$p && $i < $check){
			if($i%2 ==0)
			  ...
			  echo"<td width='80'><a href='AddScore.php?StuNo=".$row['StuNo']."&CouNo=".$row['CouNo']."'>添加成绩</a></td>";
			  echo"</tr>";
			  $j=$i+1; 
		 }
		}
